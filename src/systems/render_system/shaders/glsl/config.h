...
#define FRAG_U_IRRADIANCE_MAP_BND 0
#define FRAG_U_PREFILTERED_MAP_BND 1
#define FRAG_U_BRDF_INTEGRATION_MAP_BND 2
/* these are used by texture material shader */
#define FRAG_U_MATERIAL_ALBEDO_BND 3
#define FRAG_U_MATERIAL_METALLIC_ROUGHNESS_BND 4
#define FRAG_U_MATERIAL_AO_BND 5
